...
const AuthPopUp = (props: props): ReactElement => {
  ...
  return (
    <>
      <div className="absolute z-50 items-center justify-center w-11/12 mt-10 transform -translate-x-1/2 -translate-y-1/2 rounded-md shadow-xl top-1/2 left-1/2 sm:w-10/12 lg:w-4/12 md:w-5/12 flexCenterDiv bg-darkGrey">
